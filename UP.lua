...
-- 🔐 Delta UI Pro – สวย ทันสมัย พื้นหลังโปร่งใส 85% | ภาษาไทย พร้อมไอคอน + ฟังก์ชันทำงานจริง
-- ใช้ได้ใน Roblox Studio และ Executor เช่น Delta
...
title.Text = "🌟 Delta UI Pro – พร้อมไอคอน"
